...
public class ResumeFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            buttonD = (Button)view.findViewById(R.id.downloadButton);
            buttonD.setOnClickListener(this);
            return view;
        } catch (Exception e) {

            Log.e("Resume", "onCreateView", e);
            throw e;
        }
    }
    ...
    public void onClick(View v) {
        ...
        String URL ="https://drive.google.com/open?id=1CW5V39H0MfQi6frmvo9F-a3mgOnFZt2s";
